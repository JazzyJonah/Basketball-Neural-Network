import { n as __require } from "./chunk-DoKv51gm.js";
...
`));
	...
	async function Se() {
		...
		}) : o ? a(new WebAssembly.Instance(b, X()), b) : (ie ??= e.locateFile ? e.locateFile ? e.locateFile("ort-wasm-simd-threaded.jsep.wasm", m) : m + "ort-wasm-simd-threaded.jsep.wasm" : new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href, l = await async function(f) {
			var _ = ie;
			if (!g && !z(_)) try {
			...
			if (ur = !0, Rt()) return new Promise((t, e) => {
				He?.terminate(), _s().then(([r, n]) => {
					try {
						...
						!o.in.wasm.wasmPaths && (r || Xn) && (o.in.wasm.wasmPaths = { wasm: new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm", import.meta.url).href }), He.postMessage(o), fn = r;
					} catch (o) {
						e(o);
					}
				}, e);
